...
public class OrderBean {
	...
	private String vendorServicebased;
	private List<WeburlBean> objJson;
	...
	public List<WeburlBean> getObjJson() {
		return objJson;
	}

	public void setObjJson(List<WeburlBean> objJson) {
		this.objJson = objJson;
	}

	public String getVendorServicebased() {
		return vendorServicebased;
	}

	public void setVendorServicebased(String vendorServicebased) {
		this.vendorServicebased = vendorServicebased;
	}
	...
	public void setTimeChange(boolean isTimeChange) {
