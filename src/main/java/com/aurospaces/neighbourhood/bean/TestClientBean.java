...
public class TestClientBean {
	...
	public String getTestClientDesc() {
		return testClientDesc;
	}
	public void setTestClientDesc(String testClientDesc) {
		this.testClientDesc = testClientDesc;
	}
