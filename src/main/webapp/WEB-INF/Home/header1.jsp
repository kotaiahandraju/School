	...
	<header style="height: 70px">
		...
		<div class="logo">
			<a href="#"> <a href="dashBoard"
				style="display: inline !important"><img src="img/VVN.png"
					style="width: 65px; height: 65px;"
					alt="AKSHARA BHARATHI VIDYALAYAM">&nbsp; &nbsp; &nbsp; <b
					style="font-size: 25px; color: white !important">VVN</b></a> <span
				class="menu-toggle hidden-xs"> <i class="fa fa-bars"></i>
			</span>
			</a>
		</div>
		<div class="pull-right hidden-sm hidden-xs">
			<h1 style="color: white; font-family: sans-serif; margin: 10px;">Vijnana
				Vihara Nutakki</h1>
		</div>
		<!-- Logo ends -->
		...
		<div id='menu'>
			<ul>
				<li class=""><a href='dashBoard'> <i
						class="fa fa-tachometer"></i> <span>Dashboard</span> <!-- 							<span class="current-page"></span> -->
				</a></li>

				<li class='has-sub'><a href='#'><i class="fa fa-cogs"></i><span>General
							Settings</span></a>
					<ul>
						...
						<li><a href="HomeControl1" id="addClass"><span>Add
									Class</span></a></li>
						<li><a href='addFaculty' id="addfaculty"><span>Add
									Faculty</span></a></li>
						<li><a href='facultySubject' id="addfacultySubjects"><span>Add
									Faculty Subjects</span></a></li>
						<li><a href='subjectHome' id="subjectHome"><span>Add
									Subjects</span></a></li>
						<li><a href='classSubjects'><span>Class Subjects</span></a></li>
					</ul></li>
				<li class='has-sub'><a href='#'><i class="fa fa-users"></i><span>Student
							Details </span></a>
					<ul>
						<li><a href='studentHome' id="addStudent"><span>Add
									Student</span></a></li>
						<li><a href='viewStudent' id="viewStudent"><span>View
									Student</span></a></li>
						<li><a href='studentFeeHome'><span>Student Fee</span></a></li>
						<li><a href='viewStudentFee'><span> View Student
									Fee</span></a></li>
				...
				<li class='has-sub'><a href='#'><i
						class="fa fa-envelope-open-o"></i><span>Message</span></a>
					<ul>
						<li><a href='attendanceHome' id="messageDisplayId"><span>Attendance</span></a></li>

						<li><a href='viewAttendanceHome'><span>View
				...
				<li class='has-sub'><a href='#'><i class="fa fa-clipboard"></i><span>Exams</span></a>
					<ul>
						<li><a href='#' id="messageDisplayId" onclick=""><span>Exam
									Terms</span></a></li>
						<li><a href='#' onclick="#"><span>Exam Common
									Types</span></a></li>
						<li><a href='examType' id="" onclick="examType()"><span>Exam
									Types</span></a></li>
						<li><a href='#' onclick="#"><span>Grade Systems</span></a></li>
						<li><a href='#' id="messageDisplayId" onclick="#"><span>Subject
									Areas</span></a></li>
						<li><a href='#' onclick=""><span>Exam Systems</span></a></li>
						<li><a href='#' onclick=" "><span>Exams</span></a></li>
						<li><a href='examMarks'><span>Exam Marks</span></a></li>
						<li><a href='#' id="messageDisplayId" onclick=""><span>Exam
									Subject Area Marks</span></a></li>

						<li><a href='#' onclick=""><span>Co-Scholastic
									Areas</span></a></li>
						<li><a href='#' onclick=""><span>Co-Scholastic
									Grade Systems</span></a></li>
						<li><a href='#' onclick=""><span>Co-Scholastic
									Marks</span></a></li>
						<li><a href='#' id="messageDisplayId" onclick=""><span>Hall
									Tickets</span></a></li>

						<li><a href='#' onclick=""><span>Progress Report</span></a></li>
						<li><a href='#' onclick=""><span>Promote Exam
									Structure</span></a></li>
		...
		<div class="freebies">
			...
			<div class="sidebar-addons">
				<ul class="views">
					...
					<li><i class="fa fa-circle-o text-danger"></i>
						<div class="details">
