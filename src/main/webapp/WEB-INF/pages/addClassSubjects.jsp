					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="blog" style="border: 1px solid;">
							...
							<div class="blog-body">
								...
								<form:form action="saveClassSubject"
									commandName="classSubjectCmd" method="post" id="cls-form"
									...
									<div class="row">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												...
												<div class="col-sm-8">
													<form:select path="classId" tabindex="3"
														class="form-control" required="true">
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="form-group">
												<label for="inputEmail3" class="col-sm-4 control-label">Class
													Subjects</label>
												<div class="col-sm-8">
													<form:select path="subjectId" tabindex="2"
														class="form-control" required="true">
													...
													<thead>
														<tr role="row">
															<th class="sorting_asc" tabindex="0"
																...
																aria-sort="ascending"
																aria-label="Name: activate to sort column descending">Board</th>
															<th class="sorting" tabindex="0"
																aria-controls="basicExample" rowspan="1" colspan="1"
																aria-label="Office: activate to sort column ascending">Class</th>
															<th class="sorting hidden-sm hidden-xs" tabindex="0"
																aria-controls="basicExample" rowspan="1" colspan="1"
																aria-label="Age: activate to sort column ascending">Subjects</th>
															<th class="sorting" tabindex="0"
																aria-controls="basicExample" rowspan="1" colspan="1"
...
>>>>>>> 7bebce919617f2bdad7de46e566111032ff316c1
