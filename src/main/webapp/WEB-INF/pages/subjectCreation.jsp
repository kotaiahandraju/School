...
<%@ taglib uri="http://java.sun.com/jsp/jstl/sql" prefix="sql"%>
	...
	<script type="text/javascript" src="js/subjectCreation.js"></script>
		<!-- Dashboard Wrapper starts -->
		<div class="dashboard-wrapper">

			<!-- Top Bar starts -->
			<div class="top-bar">
				<div class="page-title" id="headId">Subject Creation</div>
			</div>
			<!-- Top Bar ends -->
									...
									<form:form action="addSubject.htm" commandName="packCmd" method="post" id="cls-form" class="form-horizontal">
											<div class="form-group">
											    ...
											    <div class="col-lg-4 col-md-4 col-sm-8">
													<form:input path="name" class="form-control onlyCharacters" tabindex="1" placeholder="Enter Subject Name" required="true"/>
